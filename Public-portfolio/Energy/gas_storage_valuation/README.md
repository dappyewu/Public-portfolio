...
This project is a portfolio/learning implementation of gas storage valuation and optimisation. It is designed to showcase data handling, modelling structure, and decision logic  and not to represent a production grade valuation system.
...
- `data/raw/forward_curve_monthly.csv` – monthly forward curve 
...
## Quick start
- Use notebooks first before CLI -  Make sure to update column name on forward curve file to delivery_month
...
- duplicate files will be created after running the CLI
---
